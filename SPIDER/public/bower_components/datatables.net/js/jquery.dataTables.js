...
(function( $, window, document, undefined ) {
	...
	var DataTable = function ( options )
	{
		 ...
		 * on display on the page, with the HTML article that is passed into the
	...
	/**
	 * Build a data source object from an HTML row, reading the article of the
	 ...
	 * presenting the API class as an array like interface. The article of the
	...
	DataTable.ext = _ext = {
		 ...
		 * live from the DOM (for example the article of an 'input' element) rather
